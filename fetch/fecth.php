                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $row)
                                            {
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="<?= $row['Middle_initial']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                 ...
                                                 <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="<?= $row['Maritus_status']; ?>" class="form-control">
                                                </div>
                                                 <div class="form-group mb-3">
                                                    <label for="">Date_of_membership</label>
                                                    <input type="text" value="<?= $row['Date_of_membership']; ?>" class="form-control">
                                                </div>
                                                <?php
